...
class NotificationFragmentAdapter(val context: Context) : RecyclerView.Adapter<NotificationFragmentAdapter.UserListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: UserListViewHolder, position: Int) {
        ...
        FirebaseDatabase.getInstance().getReference("Contractor Id's").child(clientId)
