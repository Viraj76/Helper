...
class ContractorPostAdapter(val context: Context, val oonChatOptionClicked: (String) -> Unit):RecyclerView.Adapter<ContractorPostAdapter.ContractorPostViewHolder>() {
...
//            oonChatOptionClicked(data.name!!)
////            val bundle = Bundle()
